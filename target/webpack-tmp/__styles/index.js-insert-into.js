function insert(styleEl) {
  ...
  styleEl.setAttribute("data-owner", "uu_shoppingapp_maing01-hi/uu_shoppingapp_maing01-hi@0.1.0");
  styleEl.setAttribute("data-emotion", "uushoppingapp");
  styleEl.setAttribute("data-tech", "less");

  // insert the style element
  // 1. after last matching data-emotion using technology "less"
  var els = insertionEl.querySelectorAll(`style[data-emotion="uushoppingapp"]`);
